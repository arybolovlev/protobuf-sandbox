...
type JobClient interface {
	Create(ctx context.Context, in *JobRequest, opts ...grpc.CallOption) (*JobResponse, error)
}
...
func (c *jobClient) Create(ctx context.Context, in *JobRequest, opts ...grpc.CallOption) (*JobResponse, error) {
	out := new(JobResponse)
...
type JobServer interface {
	Create(context.Context, *JobRequest) (*JobResponse, error)
...
func (UnimplementedJobServer) Create(context.Context, *JobRequest) (*JobResponse, error) {
...
func _Job_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServer).Create(ctx, req.(*JobRequest))
	}
